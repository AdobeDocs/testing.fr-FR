...
description: This article helps you download and install the client tools you will
  need for Git/GitHub and for editing Markdown files.
seo-description: This article helps you download and install the client tools you
  will need for Git/GitHub and for editing Markdown files for Adobe documentation.
index: false
Translated: TM+MT
