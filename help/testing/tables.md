...
source-git-commit: 3847027eecd6d29144dae5e529f009ab277ce5ee
workflow-type: tm+mt
...
<table>
  ...
  <tr>
    ...
    <tr>
        <th>Apples</th>
        <td><img src='/assets/premium.png'/>98 ui</td>
        <td>8.4 mg</td>
    </tr>
    <tr>
        <th>Oranges</th>
...
## Learn more about journeys {#journeys}
...
>[!CONTEXTUALHELP noid]
>title="Journeysnoid"
>abstract="noid: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"

>[!CONTEXTUALHELP notitle]
>id="journeysnotitle"
>abstract="notitle: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"

>[!CONTEXTUALHELP nodescription]
>id="journeysnodescription"
>title="Journeys"
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"

>[!CONTEXTUALHELP 3additionalurls]
>id="journeystoomanyurls"
>title="Journeys"
>abstract="3urls: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"
>additional-url="https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text="Watch demo video"

>[!CONTEXTUALHELP spaceinid]
>id="jour neysspaceinid"
>title="Journeys"
>abstract="spaceinid: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."

>[!CONTEXTUALHELP capsinid]
>id="Journeyscapsinid"
>title="Journeys"
>abstract="capsinid: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."

>[!CONTEXTUALHELP dupid]
>id="Journeysdupid"
>title="Journeys"
>abstract="dupid1: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."

>[!CONTEXTUALHELP dupid]
>id="Journeysdupid"
>title="Journeys"
>abstract="dupid2: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."
