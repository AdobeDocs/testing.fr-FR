...
source-git-commit: 81b8ec7ee4f3821d45cf35e984ee980e01d01798

---

<!--
>[!CONTEXTUALHELP beforeh1]
>id="journeysbeforeh1"
>title="Journeys"
>abstract="beforeh1: Triggered Journeys is a new Campaign feature to manage event based and real-time marketing scenarios.  It is a very open feature.  It receives events, interrogates data sources, fire actions."
-->
...
## En savoir plus sur les voyages{#journeys}
...
>[!CONTEXTUALHELP noid noid]
>titre"Journeysnoid"
>abstract-"noid: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer les scénarios de marketing basés sur les événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text

>[!CONTEXTUALHELP notitle]
>id '"journeysnotitle"
>abstract'"notitle: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer les scénarios de marketing basés sur les événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text

>[!CONTEXTUALHELP nodescription (nodescription)]
>id '"journeysnodescription"
>titre"Voyages"
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text

>[!CONTEXTUALHELP 3additionalurls]
>id"voyagestoomanyurls"
>titre"Voyages"
>abstract'"3urls: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer les scénarios de marketing basés sur les événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text
>supplémentaire-url"https://campaign-rd-voyager-mkt-dev1.campaign.adobe.com/voyager/journeys.mp4" text

>[!CONTEXTUALHELP spaceinid (spaceinid)]
>id"jour neysspaceinid"
>titre"Voyages"
>abstract'"spaceinid: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer les scénarios de marketing basés sur les événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.

>[!CONTEXTUALHELP capsinid]
>id"Journeyscapsinid"
>titre"Voyages"
>abstract'"capsinid: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer les scénarios de marketing basés sur les événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.

>[!CONTEXTUALHELP dupid]
>id"Journeysdupid"
>titre"Voyages"
>abstractMD1: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer des scénarios de marketing basés sur des événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.

>[!CONTEXTUALHELP dupid]
>id"Journeysdupid"
>titre"Voyages"
>abstractMD2: Triggered Journeys est une nouvelle fonctionnalité de campagne pour gérer des scénarios de marketing basés sur des événements et en temps réel.  C’est une fonctionnalité très ouverte.  Il reçoit des événements, interroge des sources de données, des actions de tir.
