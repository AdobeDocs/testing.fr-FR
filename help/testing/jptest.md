...
### Adobe AnalyticsのNew Features# features_ analytics{}
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>管理コンソールに移行に関する情報のAnalyticsユーザーIDの移行のヘルプおよびFederated IDを更新しました。 </p> <p>詳しくは、<a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/migrate-enterprise.html" format="html" scope="external">エンタープライズドメインおよびFederated ID</a>は、Analyticsユーザーアカウントを移行します。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(後の)参照ではメカニズムの変更はいくつかの方法でレポートに影響しています。 これらの変更により、<b>完了の周囲に実装されていることを頭に入れておく，2018となります。</b> </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C">(<b>によって、更新された月11，2018</b>)および現在のロールアップレポートデータのカテゴリのReports&amp; Analyticsは提供されません。 Web Service APIのカテゴリのロールアップレポートを使用すると、2018年5月10日のAdobe Analyticsメンテナンスリリースと効果的です。 </li> 
     <li id="li_C699A0328CFD4AC4839C481710FE29AA"> page/propデータのサポートは約2007年月(場合によっては2006)のより前ではなくなるようになりました。 これにより、ページ、prop、およびページ(つまりカスタムリンク、離脱リンク、ダウンロードリンクのみ)に影響を与えます。 <p>注意:この変更により、分析ワークスペースやData Warehouseのレポートに影響を与えません。 </p> <p>次の日付の前のデータがある場合は、次を指定します。 </p> 
      <ul id="ul_7CC6A7455BAF4ADCB7A626F2BB8A45B6"> 
       <li id="li_07D957DE7D6D4458AEA8B30910A8E8F9">投稿データは、2007年の月の境界を越えて正しく前面に結合しません。 </li> 
       <li id="li_96D1DF439E2842AE9E2FCF951ADFA9FB">検索は2007年1月より前に約データに対しては動作しません。 </li> 
      </ul> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>日付が有効と数値分類サポートについて次の変更 </p> </td> 
   <td colname="col02"> <p>7年2018月7日 </p> </td> 
   <td colname="col2"> <p>2018年5月10日メンテナンスリリースでは、数値分類を有効にした日付の機能を制限し始めます。 これらの分類タイプは<span class="uicontrol">管理</span>および<span class="uicontrol">分類インポーター</span>インターフェイスから削除されます。 </p> <p>同じ日付、新しい日付を有効にすると、数値分類は追加できません。 既存の分類は、標準の分類のワークフローによってアップロードされ(削除され)、管理できるので、レポートに追加できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>マーケティングチャネルのコスト設定と予算に対して次の変更をサポート </p> </td> 
   <td colname="col02"> <p>28年2018月11日 </p> </td> 
   <td colname="col2"> <p>月メンテナンスリリースで、<span class="uicontrol">管理</span>マーケティングチャネルのコスト設定と予算/<span class="uicontrol">マーケティングチャネル</span>メニューが削除されます。 新しいコストと予算データを追加することはできません。 あるコストと予算のデータがレポートで利用できますが、引き続き更新されません。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>コードマネージャ-既存Hコード </p> </td> 
   <td colname="col02"> <p>8年2018月11日 </p> </td> 
   <td colname="col2"> <p>コードマネージャから既存のJavaScriptコード(H)をダウンロードすることはサポートされていません。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>データ保持率:Adobe Analyticsについて、データの保持ポリシーを確認して設定します </p> </td> 
   <td colname="col02"> <p>1年2018月11日 </p> </td> 
   <td colname="col2"> <p><b>背景</b> </p> <p>EUか。データ処理ユニットとしてロールのお客様で、個人が再び実行アクセス、削除およびその他のリクエストの顧客を支援する適切な手段をが取りません」の一般ルール(データ保護GDPR)を使用すれば、2018年5月25日として適用されるからです。 アプリケーションの適切かつ安全かつ適時の削除ポリシーはこの役割に準拠することの重要な部分です。 データの保持ポリシーをGDPRが2018年5月25日に有効にされる前に実行するためには、そのため、操作を許可してください。 </p> <p><b>内容</b> </p> <p>既に適切なAdobe Analyticsデータの保持ポリシーが存在しない場合、他の設定を指定しないと、現在Adobe Analytics顧客の縮小で指定されたデータ保持率も適用し始めます。 </p> <p>Adobe Analyticsのほとんどの縮小は25か月後にデータが削除されたことを示します。 データの保持ポリシーが貴社のために設けられている場合、ローリング毎月無条件で呼び出されます。 25ヶ月以上の長期的なデータには追加料金保持率で使用できます。 短いデータの保存期間は、ご連絡カスタマーケアが設定できます。 </p> <p> まもなく組織のその他の詳細情報が含まれている電子を受け取ります。 </p> <p>データはレポート保持率&amp; amp OFMERCHANTABILITY Adobe Analytics履歴データにアクセスするためのすべてのメソッドに適用されます。amp;Analyticsと分析ワークスペース、Report Builder(APIを、Data Warehouseレポートが作成されているWeb Serviceおよびデータフィード。 </p> <p><b>次の手順</b> </p> <p>データ保持率について決める必要があり、組織内の済みを特定します。 組織では、Adobe Analyticsデータをオンにしておくと、適切な期間がわかるように設定されます。 </p> <p>Adobe Analytics保持率のデータに関する質問がございましたら、Adobe Customer成功マネージャーにお問い合わせください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>ユーザーアカウント連結 </p> </td> 
   <td colname="col02"> <p>26年2017月13日 </p> </td> 
   <td colname="col2"> <p>Analyticsユーザーエクスペリエンスは手動でCloudとAnalytics間でそのアカウントをリンクする必要はありません。 ユーザーは、<a href="https://helpx.adobe.com/enterprise/help/aedash.html" format="html" scope="external">管理コンソールの</a> Analyticsの管理者アクセス権限を要求するようにお問い合わせいただくこともできます。 
     <!--<xref href="https://jira.corp.adobe.com/browse/CORE-5526">https://jira.corp.adobe.com/browse/CORE-5526</xref>--> </p> <p>AnalyticsユーザーIDの移行は簡単に管理者がAnalytics User ManagementからAdobe管理コンソールにユーザーアカウントを移行できます。 ユーザーが移行すると、そのユーザーは、エクスペリエンスのクラウドに使用できる購入されたソリューションおよびコアサービスにアクセスできるようになりました。 </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/" format="https" scope="external"> AnalyticsユーザーIDの移行</a>の詳細をご覧ください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 管理コンソールにトランジションによって影響を受けるAPIメソッド用ソフトウェア。 </p> </td> 
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>ビューアは、AEM5.10.1とダイナミックメディアのクラシック(Scene7)のダイナミックメディアで使用できるようになりました。 </p> <p><a href="https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_rn_07_17_18.html" format="https" scope="external">ビューアのリリースノート(5.10.1)を参照してください。 </a> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>キューをロックまたはロック解除することもできます。 列をロック列およびその他のすべての列、右に横方向にスクロールできる別のウィンドウにある行がすべて1つの静的ウィンドウの左側に固定します。 </p> </td> 
  </tr> 
  <tr> 
