...
description: This article explains an overview of Git, GitHub repository, and how
  content is organized, and naming conventions used for Adobe documentation.
seo-description: this article explains an overview of git,  github repository, and
  how content is organized, and naming conventions used for adobe documentation.
index: false
Translated: TM+MT
